  ...
  return (
    <div ref={ref} id={"tc-"+card.id} style={{
      ...
      <div className="ll" style={{
        ...
        background:"#22C55E",color:"white",fontFamily:"'Roboto',sans-serif",fontWeight:700,
      ...
      <div className="nl" style={{
        ...
        background:"#EF4444",color:"white",fontFamily:"'Roboto',sans-serif",fontWeight:700,
        ...
        {members.map(m => (
          <div key={m.id} style={{ display:"flex",flexDirection:"column",alignItems:"center",gap:8 }}>
            <div style={{
              ...
              fontSize:18,fontWeight:700,color:"white",fontFamily:"'Roboto',sans-serif",
    ...
    <div style={{ width:"100%",maxWidth:420,padding:"20px 20px 40px",zIndex:10,flexShrink:0 }}>
      ...
      <div style={{ textAlign:"center",marginBottom:28 }}>
        ...
        <div style={{ display:"flex",justifyContent:"center",marginBottom:12 }}>
          {members.map((m,i)=>(
            <div key={m.id} style={{ width:38,height:38,borderRadius:"50%",background:avatarColor(m.name),display:"flex",alignItems:"center",justifyContent:"center",fontSize:14,fontWeight:700,color:"white",fontFamily:"'Roboto',sans-serif",border:"3px solid #EDE8DF",marginLeft:i>0?-10:0,zIndex:members.length-i }}>{avatarLetter(m.name)}</div>
          ))}
        </div>
          ...
          {matchedCards.map((card, i) => i === 0 ? (
            ...
            <div key={card.id}>
              <div style={{ background:"#FF3B55",borderRadius:"16px 16px 0 0",padding:"8px 16px",display:"flex",alignItems:"center",gap:6 }}>
                ...
                <span style={{ fontFamily:"'Roboto',sans-serif",fontSize:10,fontWeight:700,color:"white",letterSpacing:1,textTransform:"uppercase" }}>EN İYİ EŞLEŞME</span>
              </div>
            ...
            <div key={card.id} style={{ background:"white",borderRadius:16,overflow:"hidden",border:"1.5px solid #EAE4DC",display:"flex",alignItems:"center",boxShadow:"0 2px 8px rgba(0,0,0,0.04)" }}>
              ...
              <div style={{ padding:"12px 16px",flex:1 }}>
                <div style={{ fontFamily:"'Roboto',sans-serif",fontSize:16,color:"#1A1208",fontWeight:700,marginBottom:3 }}>{card.name}</div>
    ...
    <div style={{ minHeight:"100vh",overflowX:"hidden",overflowY:"auto",fontFamily:"'Roboto',sans-serif",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:phase==="swiping"?"flex-start":["matchList","result"].includes(phase)?"flex-start":"center",paddingTop:phase==="swiping"?"62px":["matchList","result"].includes(phase)?"32px":"0",paddingBottom:phase==="swiping"?"40px":["matchList","result"].includes(phase)?"80px":"32px",background:"#EDE8DF",backgroundImage:"repeating-linear-gradient(118deg,transparent 0,transparent 44px,rgba(180,162,140,0.07) 44px,rgba(180,162,140,0.07) 46px),repeating-linear-gradient(62deg,transparent 0,transparent 70px,rgba(170,152,130,0.05) 70px,rgba(170,152,130,0.05) 72px),linear-gradient(170deg,#F2ECE4 0%,#E8DFD3 40%,#EDE6DB 70%,#F0EAE0 100%)" }}>
      ...
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        .ghost{
          ...
          cursor:pointer;font-family:'Roboto',sans-serif;letter-spacing:0;transition:all .2s;
        }
        ...
        .demo-btn{
          ...
          cursor:pointer;font-family:'Roboto',sans-serif;transition:all .18s;
        }
      ...
      {phase==="swiping"&&(
        <nav style={{ position:"fixed",top:0,left:0,right:0,zIndex:300,display:"flex",alignItems:"center",justifyContent:"space-between",padding:"14px 22px",borderBottom:"1px solid rgba(180,162,140,0.2)",background:"rgba(237,232,223,0.92)",backdropFilter:"blur(24px)" }}>
          <div style={{ display:"flex",alignItems:"center",gap:8 }}>
            <span style={{ fontFamily:"'Roboto',sans-serif",fontSize:17,color:"#1A1208",fontWeight:700,letterSpacing:0 }}>nerede yesek<span style={{ color:"#FF3B55" }}>.</span></span>
            ...
            {isFriend&&(
              <div style={{ display:"flex" }}>
                {members.slice(0,4).map((m,i)=>(
                  <div key={m.id} style={{ width:28,height:28,borderRadius:"50%",background:avatarColor(m.name),display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,fontWeight:700,color:"white",fontFamily:"'Roboto',sans-serif",border:"2.5px solid #EDE8DF",marginLeft:i>0?-8:0,zIndex:10-i }}>{avatarLetter(m.name)}</div>
                ))}
              </div>
            )}
      ...
      {phase==="intro"&&(
        <div className="fade-up" style={{ width:"100%",maxWidth:360,zIndex:10 }}>
          ...
          <div style={{ marginBottom:28,lineHeight:1,display:"flex",flexDirection:"column",alignItems:"center",padding:"0 16px" }}>
            <div style={{ fontFamily:"'Barlow Condensed',sans-serif",fontSize:"clamp(52px,16vw,84px)",fontWeight:900,color:"#1A1208",letterSpacing:0,lineHeight:0.88 }}>Bugün</div>
            ...
            <div style={{ fontFamily:"'Barlow Condensed',sans-serif",fontSize:"clamp(52px,16vw,84px)",fontWeight:900,color:"#1A1208",letterSpacing:0,lineHeight:0.88 }}>yesek?</div>
          </div>
          ...
          <div style={{ padding:"0 24px" }}>
            ...
            <div style={{ display:"flex",flexDirection:"column",gap:10,marginBottom:14,width:"100%" }}>
              ...
              >
                ...
                <span style={{ fontSize:17,fontWeight:700,fontFamily:"'Roboto',sans-serif",letterSpacing:0 }}>Tek Başına</span>
              </button>
              ...
              >
                <span style={{ fontSize:22 }}>👥</span>
                <span style={{ fontSize:17,fontWeight:700,fontFamily:"'Roboto',sans-serif",letterSpacing:0 }}>Arkadaş Modu</span>
              </button>
            </div>
          ...
          <div style={{ background:"white",border:"1.5px solid #E8E0D4",borderRadius:20,padding:"18px 20px",marginBottom:18,boxShadow:"0 2px 8px rgba(0,0,0,0.04)" }}>
            ...
            {members.map((m,i)=>(
              <div key={m.id} style={{ display:"flex",alignItems:"center",gap:12,marginBottom:i<members.length-1?12:0 }}>
                <div style={{ width:38,height:38,borderRadius:"50%",background:avatarColor(m.name),display:"flex",alignItems:"center",justifyContent:"center",fontSize:14,fontWeight:700,color:"white",fontFamily:"'Roboto',sans-serif",flexShrink:0 }}>{avatarLetter(m.name)}</div>
                <div style={{ flex:1 }}>
                ...
                {i===0&&<span style={{ color:"white",fontSize:9,fontWeight:700,fontFamily:"'Roboto',sans-serif",background:"#1A1208",padding:"4px 10px",borderRadius:50,letterSpacing:1 }}>HOST</span>}
              </div>
            ))}
          </div>
          {isHost
      ...
      {phase==="loading"&&(
        <div style={{ textAlign:"center",padding:32,zIndex:10 }}>
          ...
          <div key={loadingStep} style={{ animation:"stepIn 0.3s ease both" }}>
            ...
            <p style={{ color:"#1A1208",fontSize:17,fontWeight:700,fontFamily:"'Roboto',sans-serif",marginBottom:6 }}>{STEPS[loadingStep].text}</p>
      ...
      {phase==="result"&&result&&(
        <div className="fade-up" style={{ textAlign:"center",padding:"20px 20px 28px",maxWidth:420,width:"100%",zIndex:10 }}>
          ...
          <div style={{ borderRadius:24,overflow:"hidden",marginBottom:18,position:"relative",height:252,background:`linear-gradient(155deg,${GRADIENTS[0][0]},${GRADIENTS[0][1]})`,boxShadow:"0 20px 56px rgba(0,0,0,0.22)" }}>
            ...
            <div style={{ position:"absolute",top:14,left:"50%",transform:"translateX(-50%)",background:"linear-gradient(135deg,#FF3B55,#FF6830)",color:"white",fontWeight:700,fontFamily:"'Roboto',sans-serif",fontSize:9,padding:"6px 20px",borderRadius:50,letterSpacing:1,whiteSpace:"nowrap" }}>✨ EN İYİ SEÇİM</div>
                ...
                {likedCards.slice(1).map(card=>(
                  <div key={card.id} style={{ background:"white",borderRadius:16,border:"1.5px solid #EAE4DC",display:"flex",alignItems:"center",overflow:"hidden",boxShadow:"0 2px 8px rgba(0,0,0,0.04)" }}>
                    ...
                    <div style={{ padding:"10px 16px",flex:1,textAlign:"left" }}>
                      <div style={{ fontFamily:"'Roboto',sans-serif",fontSize:15,color:"#1A1208",fontWeight:700,marginBottom:2 }}>{card.name}</div>
